const translations = {
    pt: {
        ...
        "hosp_def_drop_title": "Modo DROP",
        "hosp_def_drop_desc": "Abordagem furtiva e silenciosa. O pacote é descartado sem notificar o remetente, forçando um timeout no lado do atacante.",
        "hosp_def_reject_title": "Modo REJECT",
        "hosp_def_reject_desc": "Responde ativamente com RST (TCP) ou ICMP Port Unreachable. Corta a conexão instantaneamente.",
        "hosp_def_vuln_title": "Vulnerabilidades Críticas Identificadas",
        "hosp_def_vuln_1": "<strong>Legacy Software:</strong> Apache 2.4.52 no host 10.10.10.10 (Vulnerável a CVEs conhecidas).",
        "hosp_def_vuln_2": "<strong>Server Tokens:</strong> Servidor expondo versão e sistema operacional diretamente nos headers HTTP.",
        "hosp_def_action_title": "Ação Corretiva",
        "hosp_def_action_desc": "Repositórios padrão LTS frequentemente travam versões antigas por estabilidade. A solução exigiu adicionar repositórios PPA (Ondrej) para obter a versão de produção mais segura e recente.",
        "hosp_def_port_title": "Porta 40022",
        "hosp_def_port_desc": "Security by Obscurity (Ineficaz contra nmap scans)",
        "hosp_def_sshd_title": "sshd_config",
        "hosp_def_sshd_desc": "Políticas reais de restrição aplicadas",
        "hosp_def_ws_logic": "// Wireshark Filter Logic",
        "hosp_def_ws_desc": "Isola as tentativas agressivas de conexão (pacotes SYN isolados) partindo diretamente do IP da máquina atacante.",
        "hosp_def_diag_fail_title": "Diagnóstico de Falha (Antes)",
        "hosp_def_diag_fail_desc": "Qualquer usuário logado, incluindo o serviço web comprometido (www-data), podia ler arquivos alheios.",
        "hosp_def_active_def_title": "Defesa Ativa",
        "hosp_def_active_def_desc": "Configuração bem-sucedida de IPS (Suricata) bloqueando ataques de DoS e Fuzzing na camada de rede, antes mesmo de atingirem a aplicação web.",
        "hosp_def_hard_comp_title": "Hardening & Compliance",
        "hosp_def_hard_comp_desc": "Servidor atualizado via repositório seguro, SSH blindado contra força bruta e permissões de arquivos corrigidas rigorosamente conforme as políticas do Lynis.",
    ...
    en: {
        ...
        "hosp_def_drop_title": "DROP Mode",
        "hosp_def_drop_desc": "Stealthy and silent approach. The packet is discarded without notifying the sender, forcing a timeout on the attacker's side.",
        "hosp_def_reject_title": "REJECT Mode",
        "hosp_def_reject_desc": "Actively responds with RST (TCP) or ICMP Port Unreachable. Instantly cuts the connection.",
        "hosp_def_vuln_title": "Critical Vulnerabilities Identified",
        "hosp_def_vuln_1": "<strong>Legacy Software:</strong> Apache 2.4.52 on host 10.10.10.10 (Vulnerable to known CVEs).",
        "hosp_def_vuln_2": "<strong>Server Tokens:</strong> Server exposing version and OS directly in HTTP headers.",
        "hosp_def_action_title": "Corrective Action",
        "hosp_def_action_desc": "Standard LTS repositories often lock old versions for stability. The solution required adding PPA repositories (Ondrej) to obtain the safest and latest production version.",
        "hosp_def_port_title": "Port 40022",
        "hosp_def_port_desc": "Security by Obscurity (Ineffective against nmap scans)",
        "hosp_def_sshd_title": "sshd_config",
        "hosp_def_sshd_desc": "Real restriction policies applied",
        "hosp_def_ws_logic": "// Wireshark Filter Logic",
        "hosp_def_ws_desc": "Isolates aggressive connection attempts (isolated SYN packets) originating directly from the attacker machine's IP.",
        "hosp_def_diag_fail_title": "Failure Diagnosis (Before)",
        "hosp_def_diag_fail_desc": "Any logged-in user, including the compromised web service (www-data), could read other users' files.",
        "hosp_def_active_def_title": "Active Defense",
        "hosp_def_active_def_desc": "Successful IPS (Suricata) configuration blocking DoS and Fuzzing attacks at the network layer, before they even reach the web application.",
        "hosp_def_hard_comp_title": "Hardening & Compliance",
        "hosp_def_hard_comp_desc": "Server updated via secure repository, SSH shielded against brute force, and file permissions strictly corrected according to Lynis policies.",
